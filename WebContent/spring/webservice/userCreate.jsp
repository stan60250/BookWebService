...
<body class="is-faq">
    ...
    <div id="main">
        <article id="modal" class="container">
            <header><h2>帳號建立</h2></header>
            <div id="doc" class="content">
            	<form id="form" action="doUserCreate" method="POST">
					<p>
						...
						<input type="text" name="userName" size="10" requiredaria-required="true" pattern="\w{1,}"/><br>
						<font size="5" color="#888888">E-mail：</font>
						<input type="text" name="userEmail" size="10" requiredaria-required="true" pattern="^\w+\.*\w+@(\w+\.){1,5}[a-zA-Z]{2,3}$"/>
						<input type="hidden" name="enable" value="0">
					</p>
					<div style="float:left">
						已經有帳號了嗎?&nbsp;&nbsp;<a href="userLogin">立即登入</a>
					</div>
